...
typedef enum SpvReflectResourceType {
  ...
  SPV_REFLECT_RESOURCE_FLAG_ACCELERATION_SRTUCTURE_NV = 0x00000010,
...
typedef enum SpvReflectShaderStageFlagBits {
  ...
  SPV_REFLECT_SHADER_STAGE_RAYGEN_BIT				   = 0x00000100, // = VK_SHADER_STAGE_RAYGEN_BIT_NV
  SPV_REFLECT_SHADER_STAGE_ANY_HIT_BIT                 = 0x00000200, // = VK_SHADER_STAGE_ANY_HIT_BIT_NV
  SPV_REFLECT_SHADER_STAGE_CLOSEST_HIT_BIT             = 0x00000400, // = VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV
  SPV_REFLECT_SHADER_STAGE_MISS_BIT					   = 0x00000800, // = VK_SHADER_STAGE_MISS_BIT_NV
  SPV_REFLECT_SHADER_STAGE_INTERSECTION_BIT			   = 0x00001000, // = VK_SHADER_STAGE_INTERSECTION_BIT_NV
  SPV_REFLECT_SHADER_STAGE_CALLABLE_BIT				   = 0x00002000, // = VK_SHADER_STAGE_CALLABLE_BIT_NV
